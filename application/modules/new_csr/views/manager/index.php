...
<div id="content">
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5 col-md-5 col-lg-4 col-lg-offset-1 text-right">
			<h1>
                <a class="btn btn-primary" href="/manager/csr/create" rel="tooltip" title="Add new CSR" data-placement="left">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" name="filter[version]" class="form-control filter-this" placeholder="Version" />
                                                    <div class="input-group-btn"><button type="button" class="clear-filter btn"><i class="fa fa-close"></i></button></div>
                                                </div>
                                            </div>
                                        </th>
                                    ...
                                    <tr>
                                        ...
                                        <th data-hide="phone"> Ordering</th>
