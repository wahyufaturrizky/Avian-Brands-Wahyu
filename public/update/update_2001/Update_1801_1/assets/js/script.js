...
$(document).ready(function(){
	...
	// Scroll Mousewheel
	$('html, body, *:not(.owl-stage-outer)').mousewheel(function(e, delta) {
	...
	$("[data-toggle=popover]").on('shown.bs.popover', function () {
		$('.fgroup').each(function(){
			var t = $(this),
					chk = t.find("input[type=checkbox]"),
					chkt = t.find(".title-group input[type=checkbox]");
				chkt.addClass('checkAll');
